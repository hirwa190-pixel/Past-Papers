export function loginForm() {
  return `
    ...
    ">
      <h2 style="text-align:center;font-size:22px;font-weight:bold;color:#111;margin:0 0 24px;">Login</h2>
      ...
      <div style="display:flex;justify-content:center;margin-bottom:16px;">
        <button onclick="alert('Logged in!')" style="
      ...
      <p style="text-align:center;font-size:13px;color:#555;margin:0;">
        Don't have an account ? <a onclick="showSignup()" style="color:#2e7d32;cursor:pointer;font-weight:bold;">Sign up</a>
      </p>
    </div>
  `;
}